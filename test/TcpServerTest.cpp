...
void ConnMessageCallback(fas::TcpServer::TcpConnShreadPtr conn, boost::shared_ptr<Buffer> buffer, Timestamp time) {
  /*!
   * \brief str
...
int main()
{
    ...
    TcpServer *ser = new TcpServer(loop, NetAddress(AF_INET, 6686, "192.168.56.1"), 10);
